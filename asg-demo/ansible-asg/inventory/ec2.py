...
class Ec2Inventory(object):
    ...
    def __init__(self):
        ...
        self.parse_cli_args()
        self.read_settings(self.args.filters)
    ...
    def read_settings(self, filters):
    ...
    def get_instances_by_region(self, region):
        ...
        try:
            ...
            self.inventory["local"]=["127.0.0.1"]
    ...
    def add_instance(self, instance, region):
        ...
        for k, v in instance.tags.iteritems():
            ...
            if self.nested_groups:
                ...
                self.push_group(self.inventory, self.to_safe(k), v)
